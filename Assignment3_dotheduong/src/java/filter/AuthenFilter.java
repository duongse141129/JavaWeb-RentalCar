...
public class AuthenFilter implements Filter {
    ...
    public AuthenFilter() {
        ...
        USER.add("BillController");
        USER.add("LogoutController");  
        USER.add("CancelController");      
        USER.add("CheckDiscountController");
        USER.add("DeleteBillController");
        USER.add("RateController");
        USER.add("SearchController");
        USER.add("SearchHistoryController");
        USER.add("UpdateBillController");
        USER.add("ViewHistoryController");
        USER.add("ViewOrderController");
        USER.add("viewHistory.jsp");
        USER.add("viewOrder.jsp");
        
        ADMIN =new ArrayList<>();
        ADMIN.add("");
        ADMIN.add("login.jsp");
        ADMIN.add("LoginController");
        ADMIN.add("management.jsp");
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            if (uri.contains(".jpg") || uri.contains(".png") || uri.contains(".gif") || uri.contains(".css")) {
                ...
                if ( uri.contains("login.jsp")  || uri.contains("LoginController") ||uri.contains("RegistrationController") || uri.contains("registration.jsp") || uri.contains("CreateUserController") 
                        || uri.contains("SearchController") || uri.contains("LogoutController") || uri.contains("SendMailController") || uri.contains("VerifyController") || uri.contains("verify.jsp") ) {
                    chain.doFilter(request, response);
                    return;
                }
