...
public class DeleteBillController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String rentDate=request.getParameter("txtDateRent");
            String returnDate=request.getParameter("txtDateReturn");
            String key=carID+";"+rentDate+";"+returnDate;
            ...
            log("error at DeleteBillController: "+e.toString());
        }finally{
